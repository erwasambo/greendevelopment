...
public class DataBaseManager extends SQLiteOpenHelper{
    ...
    private static String DB_PATH = "/data/data/com.green.development/databases/";
    //the name of my database
    private static String DB_NAME = "greendevelopmentdb";
    //general table
    ...
    private boolean checkDataBase() {
        ...
        try {
            ...
            Log.e("DataBase", "Database Checked");
    ...
    public Cursor select(String query) throws SQLException {
    	...
    	Log.e("Databasehelper", "Values selected********************************");
    ...
    public void insert(String table, ContentValues values) throws SQLException {
        ...
        Log.e("Databasehelper", "Values inserted********************************");
    }
    ...
    public void delete(String table, String where) throws SQLException {
        ...
        Log.e("Databasehelper", "Values deleted********************************");
    }
    ...
    public void update(String table, ContentValues values, String where) {
        ...
        Log.e("Databasehelper", "Values updated********************************");
    ...
    public synchronized void close() {
        ...
        super.close();
        Toast.makeText(ApplicationContextProvider.getContext(), "Database closed", Toast.LENGTH_LONG).show();
    }
