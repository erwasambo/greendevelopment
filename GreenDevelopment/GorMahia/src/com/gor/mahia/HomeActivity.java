...
import com.gor.mahia.PoppyViewHelper;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		View poppyView = mPoppyViewHelper.createPoppyViewOnListView(R.id.listView1, R.layout.poppyview, new AbsListView.OnScrollListener() {
			...
			public void onScrollStateChanged(AbsListView view, int scrollState) {
				Log.d("HomeActivity", "onScrollStateChanged");
			}

			@Override
			public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
				Log.d("HomeActivity", "onScroll");
			}
		});
		...
		poppyView.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				 Intent browse = new Intent( Intent.ACTION_VIEW , Uri.parse( "http://kikosoftwareltd.com" ) );
